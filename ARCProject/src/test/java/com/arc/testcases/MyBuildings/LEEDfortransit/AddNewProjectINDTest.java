...
public class AddNewProjectINDTest extends BaseClass {
	...
	@Test(dependsOnMethods={"com.arc.testcases.MyBuildings.LEEDfortransit.LoginCaseTest.loginCaseTest"})
	public void addNewProjectTest() throws IOException {
		...
		try {
			...
			reuseAddProject.AddProjectLEEDIND(driver);
			...
			CommonMethod.takeScreenshot(driver, "addNewProjectUSTest-LEEDfortransit");
			throw e1;
		}
	}
