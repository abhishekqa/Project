...
public class BaseScoreAttemptTest extends BaseClass {
	...
	public void baseScoreAttemptTest() throws IOException {
		...
		try {
			...
			//reuseSearch.VerifySearchedProgram(driver, "1000137133");
			...
			reuseBS.TBasescoreAttempt(driver);
			...
			CommonMethod.takeScreenshot(driver, "renewableAllBaseScoreAttemptTest-TransitU");
			throw e1;
		}
	}
