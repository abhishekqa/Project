...
public class PaymentbyCCTest extends BaseClass {
	...
	@Test(dependsOnMethods = { "com.arc.testcases.MyBuildings.LEEDfortransit.LoginCaseTest.loginCaseTest","com.arc.testcases.MyBuildings.LEEDfortransit.ClickSearchedProgramTest.clickSearchedProgramTest","com.arc.testcases.MyBuildings.LEEDfortransit.UnderGroundAddNewProjectTest.addNewProjectTest" })
	public void paymentbyCCTest() throws IOException {
		...
		try {
			...
			CommonMethod.takeScreenshot(driver, "paymentbyCCTest-TransitU");
			throw e1;
		}
	}
