...
public class PrerequisitesAttemptTest extends BaseClass {
	...
	public void prerequisitesAttemptTest() throws IOException {
		...
		//	reuseSearch.VerifySearchedProgram(driver, "1000137574");
			...
			reusePrereq.PrereqAttempt(driver,"sitemanagement",9);
			...
			CommonMethod.takeScreenshot(driver, "prerequisitesAttemptTest-TransitU");
			throw e1;
		}
	}
