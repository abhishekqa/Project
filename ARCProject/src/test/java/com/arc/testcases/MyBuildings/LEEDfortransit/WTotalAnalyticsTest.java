...
public class  WTotalAnalyticsTest extends BaseClass {
	...
	public void verifyWDailiyMTCO2Test() throws IOException {
		...
		try {
			...
			reuseDI.verifyWDailiyMTCO2e(driver,"Atotal");
			...
			CommonMethod.takeScreenshot(driver, "wDailiyMTCO2eTest-TransitU");
			throw e1;
		}
	}
