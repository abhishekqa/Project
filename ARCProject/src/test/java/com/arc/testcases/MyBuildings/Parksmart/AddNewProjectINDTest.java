...
public class AddNewProjectINDTest extends BaseClass {
	...
	@Test
	//(dependsOnMethods={"com.arc.testcases.buildings.LoginCaseTest.loginCaseTest"})
	public void addNewProjectTest() throws IOException {
		...
		try {
			...
			reuse.LoginWithparking(4, "My Parking");
			reuseAddProject.AddProjectParksmartIND(driver);
			...
			CommonMethod.takeScreenshot(driver, "addNewProjectUSTest-Parking");
			throw e1;
		}
	}
