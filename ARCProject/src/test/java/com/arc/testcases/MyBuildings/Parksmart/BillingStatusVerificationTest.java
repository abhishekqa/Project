...
public class BillingStatusVerificationTest extends BaseClass {
	...
	public void billingStatusVerificationTest() throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Billing Status Test-Parking", "Verifies if billing status is displaying correct in billing page").assignCategory("CheckBilling");
		...
		try {
			...
			CommonMethod.takeScreenshot(driver, "billingStatusVerificationTest-Parking");
			throw e1;
		}
	}
