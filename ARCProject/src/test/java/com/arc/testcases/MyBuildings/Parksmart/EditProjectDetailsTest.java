...
public class EditProjectDetailsTest extends BaseClass {
	...
	public void editProjectDetailsTest() throws IOException {
		...
		try {	
			...
			reuseManage.editProjectDetailsParking(driver);
			...
			CommonMethod.takeScreenshot(driver, "editProjectDetailsTest-Parking");
			throw e1;
		}
	}
