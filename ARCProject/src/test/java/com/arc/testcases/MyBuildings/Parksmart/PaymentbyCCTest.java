...
public class PaymentbyCCTest extends BaseClass {
	...
	@Test(dependsOnMethods = { "com.arc.testcases.MyBuildings.Parksmart.LoginCaseTest.loginCaseTest","com.arc.testcases.MyBuildings.Parksmart.ClickSearchedProgramTest.clickSearchedProgramTest","com.arc.testcases.MyBuildings.Parksmart.AddNewProjectTest.addNewProjectTest" })
	public void paymentbyCCTest() throws IOException {
		...
		try {
			...
			CommonMethod.takeScreenshot(driver, "paymentbyCCTest-Parksmart");
			throw e1;
		}
	}
