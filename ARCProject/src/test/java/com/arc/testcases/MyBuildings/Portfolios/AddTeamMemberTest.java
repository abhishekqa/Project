...
public class AddTeamMemberTest extends BaseClass {
	...
	public void addTeamMemberTest() throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Add Team Member Test-BNone", "Verifies if TeamMember add functionality is working fine").assignCategory("CheckTeam");
		...
		try {
			...
			CommonMethod.takeScreenshot(driver, "addTeamMemberTest-BNone");
			throw e1;
		}
	}
