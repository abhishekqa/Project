...
public class BillingDateVerificationTest extends BaseClass {
	...
	public void billingDateVerificationTest() throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Billing DateTest-BNone", "Verifies if Billing Date is correct").assignCategory("CheckBilling");
		...
		try {
			...
			CommonMethod.takeScreenshot(driver, "billingDateVerificationTest-BNone");
			throw e1;
		}
	}
