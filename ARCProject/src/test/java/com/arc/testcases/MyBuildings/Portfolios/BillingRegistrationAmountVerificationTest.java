...
public class BillingRegistrationAmountVerificationTest extends BaseClass {
	...
	public void billingRegistrationAmountVerificationTest() throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("RegistrationAmount Test-BNone", "Verifies if registration amount is displayed correct in billing page").assignCategory("CheckBilling");
		...
		try {
			...
			CommonMethod.takeScreenshot(driver, "billingRegistrationAmountVerificationTest-BNone");
			throw e1;
		}
	}
