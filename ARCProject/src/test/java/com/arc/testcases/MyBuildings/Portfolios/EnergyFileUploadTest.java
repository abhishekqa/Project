...
public class  EnergyFileUploadTest extends BaseClass {
	...
	public void energyFileUploadTest() throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Create Energy MeterTest-BNone", "Verifies if Energy meter created and added successfully").assignCategory("CheckMeter");
		...
		try {
			...
			reuseDI.EnergyUploadxls(driver,"Energy");
			...
			CommonMethod.takeScreenshot(driver, "energyFileUploadTest-BNone");
			throw e1;
		}
	}
