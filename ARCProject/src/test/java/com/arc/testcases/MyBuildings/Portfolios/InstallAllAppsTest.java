...
public class InstallAllAppsTest extends BaseClass {
	...
	public void installAllAppsTest() throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Install AppsTest-BNone", "Verifies if Apps functionality is working fine").assignCategory("CheckApps");
		...
		try {
			...
			reuseManage.InstallApps(driver);
