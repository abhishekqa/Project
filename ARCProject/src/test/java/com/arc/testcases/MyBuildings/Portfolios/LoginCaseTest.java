...
public class LoginCaseTest extends BaseClass {
	...
	public void loginCaseTest()throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Login Test-BNone", "Verifies if Login functionality is working fine").assignCategory("CheckLogin");
		...
		try {
			...
			CommonMethod.takeScreenshot(driver, "loginCaseTest-BNone");
			throw e1;
		}
	}
