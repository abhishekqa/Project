...
public class SearchProgramTest extends BaseClass {
	...
	public void searchProgramTest() throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("SearchProgram Test-BNone", "Verifies if Search functionality is working fine").assignCategory("CheckSearch");
		...
		try {
			...
			reuseSearch.SearchProgram(driver, "1000128006");
			...
			CommonMethod.takeScreenshot(driver, "searchProgramTest-BNone");
			throw e1;
		}
	}
