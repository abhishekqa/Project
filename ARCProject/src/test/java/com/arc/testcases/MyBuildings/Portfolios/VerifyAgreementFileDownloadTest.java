...
public class VerifyAgreementFileDownloadTest extends BaseClass {
	...
	public void verifyAgreementFileDownloadTest() throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Agreement File DownloadTest-BNone", "Verifies if Login functionality is working fine").assignCategory("CheckLogin");
		...
		try {
			...
			CommonMethod.takeScreenshot(driver, "verifyAgreementFileDownloadTest-BNone");
			throw e1;
		}
	}
