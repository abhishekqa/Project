...
public class VerifyPRFileDownloadTest extends BaseClass {
	...
	public void billingStatusVerificationTest() throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("RegistraionPDFDownloadTest-BNone", "Verifies if billing status is displaying correct in billing page").assignCategory("CheckBilling");
		...
		try {
			...
			reuseManage.verifyDownloadPRPdf(driver);
			...
			CommonMethod.takeScreenshot(driver, "billingStatusVerificationTest-BNone");
			throw e1;
		}
	}
