...
public class WasteMeterCreateTest extends BaseClass {
	...
	public void wasteMeterCreateTest() throws IOException {
		
		CommonMethod.ExtentReportConfig(driver);
		
		CommonMethod.test = CommonMethod.extent.startTest("WasteReadingDataFillTest-BNone", "Verifies if Waste Reading added successfully").assignCategory("AddReading");
		...
		try {
			...
			reuseDI.CreateWasteMeter(driver,"Waste");
			...
			CommonMethod.takeScreenshot(driver, "wasteMeterCreateTest-BNone");
			throw e1;
		}
	}
