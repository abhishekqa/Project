...
public class WaterFileUploadTest extends BaseClass {
	...
	public void waterFileUploadTest() throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Water File UploadTest-BNone", "Verifies  Water File Uploaded successfully").assignCategory("FileUpload");
		...
		try {
			...
			reuseDI.WaterFileUploadxls(driver,"Water");
			...
			CommonMethod.takeScreenshot(driver, "WaterFileUploadTest-BNone");
			throw e1;
		}
	}
