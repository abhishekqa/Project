...
public class ClickSearchedProgramTest extends BaseClass {
	...
	@Test(dependsOnMethods = { "com.arc.testcases.communities.LoginCaseTest.loginCaseTest"})
	public void clickSearchedProgramTest() throws IOException {
		...
		try {
			...
			reuseSearch.VerifySearchedProgram(driver, "1000124490");
			...
			CommonMethod.takeScreenshot(driver, "clickSearchedProgramTest-communities");
			throw e1;
		}
	}
