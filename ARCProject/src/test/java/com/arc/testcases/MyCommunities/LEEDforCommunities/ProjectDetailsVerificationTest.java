...
public class ProjectDetailsVerificationTest extends BaseClass {
	...
	public void projectDetailsVerificationTest() throws IOException {
		...
		try {
			...
			CommonMethod.takeScreenshot(driver, "projectDetailsVerificationTest-communities");
			throw e1;
		}
	}
