...
public class WasteMeterEditReadingTest extends BaseClass {
	...
	@Test(dependsOnMethods = { "com.arc.testcases.MyCommunities.LEEDforCommunities.LoginCaseTest.loginCase","com.arc.testcases.MyCommunities.LEEDforCommunities.SearchProgramTest.searchProgram","com.arc.testcases.MyCommunities.LEEDforCommunities.ClickSearchedProgramTest.clickSearchedProgram","com.arc.testcases.MyCommunities.LEEDforCommunities.sPaymentbyCCTest.paymentbyCC" })
	...
	public void wasteMeterEditReading(int rowNum, String loginSheet, String communitySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Waste Meter Edit Reading Test", "Verifies if Login functionality is working fine").assignCategory("CheckLogin");
