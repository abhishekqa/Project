...
public class WasteMeterEditReadingTest extends BaseClass {
	...
	@Test(dependsOnMethods = { "com.arc.testcases.communities.LoginCaseTest.loginCaseTest","com.arc.testcases.communities.SearchProgramTest.searchProgramTest","com.arc.testcases.communities.ClickSearchedProgramTest.clickSearchedProgramTest","com.arc.testcases.communities.sPaymentbyCCTest.paymentbyCCTest" })
	public void wasteMeterEditReadingTest() throws IOException {
		...
		try {
			...
			reuseDI.EditWasteMeter(driver, "Waste");
			...
			CommonMethod.takeScreenshot(driver, "wasteMeterEditReadingTest-communities");
			throw e1;
		}
	}
