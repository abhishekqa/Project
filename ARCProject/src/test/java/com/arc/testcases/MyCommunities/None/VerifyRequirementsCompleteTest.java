...
public class VerifyRequirementsCompleteTest extends BaseClass {
	...
	public void verifyRequirementsCompleteTest() throws IOException {
		...
		try {
			...
			CommonMethod.takeScreenshot(driver, "verifyRequirementsCompleteTest-communities");
			throw e1;
		}
	}
